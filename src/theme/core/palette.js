 ...
 */
export const text = {
  light: createPaletteChannel({ primary: '#1A1D21', secondary: grey[600], disabled: grey[500] }), // EdgeLink text-dark
  dark: createPaletteChannel({ primary: '#FFFFFF', secondary: grey[500], disabled: grey[600] }),  // EdgeLink text-light
};

export const background = {
  light: createPaletteChannel({ paper: '#FFFFFF', default: '#FFFFFF', neutral: grey[100] }), // Using EdgeLink gray-100 for neutral
